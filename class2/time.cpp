...
#include "time.h"    // Para visualizar a class Time

using namespace std; // Para escrever cout ao invé de std::cout
...
// Nos métodos [set], a classe está recebendo como params uma variável com o mesmo
// nome do atributo. Esse fato faz com que o atributo seja [escondido]. Por exemplo,
// no método [setHour] abaixo, quando usarmos a variável [hour], estaremos nos 
// referindo ao params e não ao atributo da classe.
//
...
//    - hour, minute e second se referem aos params dos métodos abaixo

// Setters
                   /*params*/
void Time::setHour(int hour) { 
  /* this (object actual) que recebe o valor passado por params */
  this->hour = hour;
}
